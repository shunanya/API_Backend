 ...
 *          this path should be exist if parent isn't given
 * @param parent_path (STRING OPTIONAL) the relative or absolute parent folder path
 *          this path should be exist if it's given in relative manner
 ...
 * @param query (STRING) the source query
 * @param ignore (STRING | ARRAY) the key(s) to be ignored (not to be exist in masking object)
 ...
 * @param ignore (STRING | ARRAY) the key(s) to be ignored (not to be exist in output string)
 * @param mask (STRING | ARRAY) the key(s) to be masking (like '***abc')
